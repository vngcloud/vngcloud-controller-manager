...
func (s *vksController) EnsureGetLoadBalancer(pCtx lCtx.Context, pClusterID string, pService *lCoreV1.Service) (*lCoreV1.LoadBalancerStatus, bool, error) {
...
func (s *vksController) GetLoadBalancerName(pCtx lCtx.Context, pClusterID string, pService *lCoreV1.Service) string {
	return lUtils.GenCompleteLoadBalancerName(pClusterID, pService)
}

func (s *vksController) EnsureLoadBalancer(pCtx lCtx.Context, pClusterID string, pService *lCoreV1.Service, pNodes []*lCoreV1.Node) (rLb *lCoreV1.LoadBalancerStatus, rErr error) {
...
func (s *vksController) UpdateLoadBalancer(pCtx lCtx.Context, pClusterID string, pService *lCoreV1.Service, pNodes []*lCoreV1.Node) error {
...
func (s *vksController) EnsureLoadBalancerDeleted(pCtx lCtx.Context, pClusterID string, pService *lCoreV1.Service) error {
...
func (s *vksController) getProjectID() string {
	return s.extraInfo.ProjectID
}

func (s *vksController) findLoadBalancer(pLbName, pLbID string, pLbs []*lObjects.LoadBalancer, // params
...
func (s *vksController) configureLoadBalancerParams(pService *lCoreV1.Service, pNodes []*lCoreV1.Node, // params
...
func (s *vksController) createLoadBalancer(pLbName string, pService *lCoreV1.Service, pServiceConfig *serviceConfig) ( // params
...
func (s *vksController) waitLoadBalancerReady(pLbID string) (*lObjects.LoadBalancer, error) {
...
func (s *vksController) checkListeners(
...
func (s *vksController) ensurePool(
...
func (s *vksController) ensureListener(
...
func (s *vksController) ensureSecgroup(pCluster *lObjects.Cluster) error {
...
func (s *vksController) findDefaultSecgroup() (*lObjects.Secgroup, error) {
...
func (s *vksController) createLoadBalancerStatus(addr string) *lCoreV1.LoadBalancerStatus {
	status := &lCoreV1.LoadBalancerStatus{}
	// Default to IP
...
func (s *vksController) updatePoolMembers(
...
func (s *vksController) canDeleteThisLoadBalancer(pLb *lObjects.LoadBalancer, pCluster *lObjects.Cluster, pService *lCoreV1.Service) bool {
...
func (s *vksController) deleteListenersAndPools(
